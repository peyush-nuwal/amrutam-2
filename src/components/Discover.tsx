...
const Discover:React.FC = () => {
  return (
    <div className="px-4 mt-16 flex flex-col  items-center my-20">
      <h1 className="text-3xl lg:text-4xl  text-center text-green font-bold">
        Discover Ayurveda’s magic with us
      </h1>
      <p className=" w-auto lg:w-7/12 text-lg  text-center mt-4 mx-1 text-lightText">
      ...
      <div className=" hidden lg:flex h-full w-4/5">
        <div className=" h-screen   flex flex-col  justify-evenly relative">
          {/* first div */}
          <div className=" relative left-16 top-5  -mr-5 w-full  rounded-lg flex flex-row-reverse justify-start items-center px-3 py-4 gap-2">
            <div className="bg-[#EDF5FA] w-20 h-20 p-4 rounded-full flex justify-center items-center shrink-0 ">
              <img
                src={heartbeat}
                alt="card-1"
            ...
            <div>
              <h4 className="text-end font-bold text-lg  leading-tight text-nowrap">
                Personalized Wellness
              </h4>
              <p className=" text-lightText font-semibold text-sm  text-end">
                treatments made just for you based on your individual doshas,
                (body type)
              </p>
            </div>
          ...
          {/* third div */}
          <div className=" relative   w-full  rounded-lg flex flex-row-reverse justify-start items-center px-3 py-4 gap-2">
            <div className="bg-[#FCF1F1] w-20 h-20 p-4 rounded-full flex justify-center items-center shrink-0 ">
              <img
                src={ribbon}
                alt="card-3"
            ...
            <div>
              ...
              <p className="text-end text-lightText font-semibold text-sm ">
                {" "}
                Keep your mind and body in sync for a happy life.
              </p>
            </div>
          ...
          {/* fifth div */}
          <div className="  relative left-16 -top-5 w-full  rounded-lg flex flex-row-reverse justify-start items-center px-3 py-4 gap-2">
            <div className="bg-[#FEF6ED] w-20 h-20 p-4 rounded-full flex justify-center items-center shrink-0 ">
              <img
                src={pestle}
                alt="card-5"
        ...
        <div className="relative  w-full mt-5 flex justify-center items-center ">
          <img
            src={girlBg}
            alt="girl-background"
            className="w-full h-full  object-contain   "
        ...
        <div className=" h-screen  flex flex-col  justify-evenly relative">
          {/* second div */}
          <div className="  relative right-16 top-5  w-full  rounded-lg flex flex-row justify-start items-center px-3 py-4 gap-2 ">
            <div className="bg-[#EAF2EA] w-20 h-20 p-4 rounded-full flex justify-center items-center shrink-0 ">
              <img
                src={lotus}
                alt="card-2"
            ...
            <div className="">
              <h4 className="text-start font-bold text-lg  leading-tight text-nowrap">
                Focus on prevention
              </h4>
              <p className="text-start text-lightText font-semibold text-sm ">
                {" "}
                Stop problems even before they start.
              </p>
            </div>
          ...
          {/* fourth div */}
          <div className=" relative  w-full  rounded-lg flex flex-row justify-start items-center px-3 py-4 gap-2">
            <div className="bg-[#F5F3FC] w-20 h-20 p-4 rounded-full flex justify-center items-center shrink-0 ">
              <img
                src={protection}
                alt="card-4"
          ...
          {/* sixth div */}
          <div className="  relative right-16 -top-5 w-full  rounded-lg flex flex-row justify-start items-center px-3 py-4 gap-2 shrink-0">
            <div className="bg-[#EAF2EA] w-20 h-20 p-4 rounded-full flex justify-center items-center shrink-0 ">
              <img
                src={strong}
                alt="card-6"
